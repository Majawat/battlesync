...
export class ArmyController {
   ...
   */
  async importArmy(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   * GET /api/armies
   */
  async getUserArmies(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
   ...
   * GET /api/armies/:id
   */
  async getArmy(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
   ...
   */
  async syncArmy(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async updateCustomizations(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async deleteArmy(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async addBattleHonor(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async addVeteranUpgrade(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async validateArmy(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      const armyId = req.params.id;
   ...
   */
  async getArmyForgeStatus(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
   ...
   */
  async clearArmyForgeCache(req: Request, res: Response): Promise<void> {
    try {
...
export const armyController = new ArmyController();